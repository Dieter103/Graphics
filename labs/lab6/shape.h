...
void add_vertex(T& coords, const N& x, const N& y, const N& z,
        ...
        const Vector& n=Vector(0,0,0), bool with_noise=false) {
...
//        norm = Vector(0,0,0);
        ...
        if(coords.at(i+6) == 0 && coords.at(i+7) == 0 && coords.at(i+8) == 0){
            coords.at(i+6) = norm.x();
            coords.at(i+7) = norm.y();
            coords.at(i+8) = norm.z();
        }else{
            coords.at(i+6) = (norm.x() + coords.at(i+6))/2;
            coords.at(i+7) = (norm.y()+coords.at(i+7))/2;
            coords.at(i+8) = (norm.z() + coords.at(i+8))/2 ;

        }
        if(coords.at(i+15) == 0 && coords.at(i+16) == 0 && coords.at(i+17) == 0){
            coords.at(i+15) = norm.x();
            coords.at(i+16) = norm.y();
            coords.at(i+17) = norm.z();
        }else{
            coords.at(i+15) = (norm.x()+ coords.at(i+15))/2 ;
            coords.at(i+16) = (norm.y() + coords.at(i+16))/2;
            coords.at(i+17) = (norm.z() +  coords.at(i+17))/2;
        }if(coords.at(i+24) == 0 && coords.at(i+25) == 0 && coords.at(i+26) == 0){
            coords.at(i+24) = norm.x();
            coords.at(i+25) = norm.y();
            coords.at(i+26) = norm.z();
        }else{
            coords.at(i+24) = (norm.x()+ coords.at(i+24))/2 ;
            coords.at(i+25) = (norm.y() + coords.at(i+25))/2;
            coords.at(i+26) = (norm.z() +  coords.at(i+26))/2;
        }
